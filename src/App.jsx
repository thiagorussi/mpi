...
import { CssBaseline, ThemeProvider, createTheme, Typography, Box, Button, Grid, Accordion, AccordionSummary, AccordionDetails } from '@mui/material';
    ...
    <ThemeProvider theme={theme}>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', backgroundColor: '#0c0d1b', color: '#fff', textAlign: 'center' }}>
        ...
        <Box sx={{ py: 10, width: '100%', backgroundColor: '#0c0d1b' }}>
          <img src={Logo} alt="Logo MPI" style={{ maxWidth: '400px', marginBottom: '20px' }} />
        ...
        <Box id="video" sx={{ py: 10 }}>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'center', mt: 3 }}>
            <Box sx={{ position: 'relative', width: '700px', height: '500px', overflow: 'hidden', background: 'none' }}>
              <iframe
        ...
        <Box sx={{ py: 10, backgroundColor: '#0c0d1b' }}>
          ...
          <Grid container spacing={4} justifyContent="center">
            <Grid item>
              <Box sx={{ maxWidth: 345, m: 2, p: 2, background: 'linear-gradient(90deg, #8ff442 0%, #00ff7f 100%)', color: '#0c0d1b', borderRadius: 5 }}>
